...
def _in_trading_session(symbol: str) -> bool:
    ...
    if symbol in _ALWAYS_ON:
        # Jump and Step indices are technically 24/7 but produce
        # very noisy signals at dead hours — restrict to 06:00-22:00 UTC.
        if symbol in ("Step Index", "Jump 75 Index", "Jump 100 Index"):
