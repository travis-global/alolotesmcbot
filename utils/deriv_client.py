...
async def _place_order_async(symbol: str, direction: str,
    ...
    multiplier    = 10              # 10x — works on both forex and synthetics
    ...
    # Deriv only accepts order_amount — no order_type field.
    if entry and sl and tp:
        try:
            ...
            if sl_usd > 0 and tp_usd > 0:
                params["limit_order"] = {
                    "stop_loss":   {"order_amount": -sl_usd},
                    "take_profit": {"order_amount":  tp_usd},
                }
        except Exception:
            pass
